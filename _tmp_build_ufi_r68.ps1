...
$preview = Join-Path $root '_tmp_ipk_preview\luci-app-ufi-tools_1.0.0-r68_all.ipk'
$desktop = 'C:\Users\shier\Desktop\luci-app-ufi-tools_1.0.0-r68_all.ipk'
$scriptWin = Join-Path $env:TEMP 'codex_build_ufi_r68.sh'
...
set -e
ROOT='$rootWsl'
PKGROOT='/tmp/luci-app-ufi-tools-r68'
OUT='/tmp/luci-app-ufi-tools_1.0.0-r68_all.ipk'
