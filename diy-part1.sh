...
if [ -d "${GITHUB_WORKSPACE}/package/luci-app-home-dashboard" ]; then
  mkdir -p package/luci-app-home-dashboard
  cp -a "${GITHUB_WORKSPACE}/package/luci-app-home-dashboard/." package/luci-app-home-dashboard/
else
